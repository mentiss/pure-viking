...
//
// ⚠️  loadSessionWithCharacters ne sélectionne QUE les colonnes présentes dans
//     TOUS les schémas de systèmes. Les colonnes spécifiques (prenom, surnom,
//     saga_actuelle, tokens_blessure…) ne sont PAS incluses ici.
//     Le nom complet du personnage est chargé via GET /characters/:id (route
//     spécifique au système) dans les composants GM de chaque slug.
...
/**
 * Charge une session avec la liste minimale de ses personnages.
 * Seules les colonnes universelles (présentes dans tous les slugs) sont lues.
 *
...
function loadSessionWithCharacters(db, sessionId) {
    ...
    return {
        ...
        characters: characters.map(c => ({
            ...
            name:       c.char_display_name || c.player_name,  // nom du personnage
...
// GET / — Liste toutes les sessions (GM)
...
// POST /:sessionId/characters/:characterId — Ajouter un perso à la session
...
// DELETE /:sessionId/characters/:characterId — Retirer un perso de la session
